/*****************************************************************************\
 *  task_affinity_drom.c - Library for task pre-launch and post_termination
 ...
 */
const char plugin_name[]        = "task affinity DROM plugin";
const char plugin_type[]        = "task/affinity_drom";
...
#endif
	if(rc == SLURM_SUCCESS)
		rc = DLB_Drom_Register_task(job, cur_mask);
	return rc;
}
